                                ...
                                <div class="gds-footer__logo-bi">
                                    <a class="gds-logo" href="#" target="_parent">
                                        <div class="gds-image gds-image--spacer-none">
                                            <picture> <img src="{{ asset('public/img/logo-footer.png') }}" height="56" width="112" alt="Boehringer Ingelheim" title="Boehringer Ingelheim" loading="lazy" class=" ls-is-cached lazyloaded"> </picture>
